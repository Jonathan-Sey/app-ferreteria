        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    @endif
                    <th scope="col" class="text-left border-0">Dia</th>
                    <th scope="col" class="text-center border-0">Efectivo</th>
                    <th scope="col" class="text-center border-0">Credito</th>
                    <th scope="col" class="text-center border-0">Tarjeta</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endif
                    <td class="text-left">{{ $item->dia }}</td>
                    <td class="text-center">
                        {{ $invoice->formatCurrency($item->price_per_unit) }}
                    </td>
                    <td class="text-center">{{ $invoice->formatCurrency($item->credito) }}</td>
                    <td class="text-center">{{ $invoice->formatCurrency($item->tarjeta) }}</td>
