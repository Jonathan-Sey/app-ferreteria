        ...
        <style type="text/css" media="screen">
            ...
            .table thead th {
                ...
                border-bottom: 2px solid #dee2e6;
                 /*padding-bottom: 0.25rem;  Ajustar el padding inferior del encabezado */
            }
            ...
            * {
            ...
            .party-header {
                font-size: 1.5rem;
                font-weight: 400;
               /* margin-bottom: 0.25rem;  Reducir el margen inferior del encabezado */
            }
            .total-amount {
                font-size: 12px;
                font-weight: 700;
                    ...
                    <td class="px-0">
                        ...
                        @if($invoice->seller->address)
                            <p class="seller-address">
                                <strong>{{ __('invoices::invoice.address') }}: {{ $invoice->seller->address }}</strong>
                            </p>
                        @endif

                        @if($invoice->seller->code)
                            <p class="seller-code">
                                <strong>{{ __('invoices::invoice.code') }}: {{ $invoice->seller->code }}</strong>
                            </p>
                        @endif

                        @if($invoice->seller->vat)
                            <p class="seller-vat">
                                <strong>{{ __('invoices::invoice.vat') }}: {{ $invoice->seller->vat }}</strong>
                            </p>
                        @endif

                        @if($invoice->seller->phone)
                            <p class="seller-phone">
                                <strong>{{ __('invoices::invoice.phone') }}: {{ $invoice->seller->phone }}</strong>
                            </p>
                        @endif
        ...
        <table class="table table-items">
            <thead>
                <tr style="background-color: #f3f4f6;">
                    ...
                    @endif
                    <th scope="col" class="text-center border-0">Descripcion</th>
