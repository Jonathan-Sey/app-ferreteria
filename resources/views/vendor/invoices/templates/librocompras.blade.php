        ...
        <table class="table table-items">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-center border-0">Doc.</th>
                    <th scope="col" class="text-center border-0">Producto</th>
                    <th scope="col" class="text-center border-0">Compras</th>
                    <th scope="col" class="text-center border-0">Servicios </th>
                    <th scope="col" class="text-center border-0">IVA </th>
