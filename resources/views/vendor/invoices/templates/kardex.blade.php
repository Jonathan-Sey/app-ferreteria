        ...
        <table class="table table-items">
            <thead>
                <tr style="background-color: #f3f4f6;">
                    ...
                    @endif
                    <th scope="col" class="text-center border-0">Ingreso</th>
                    <th scope="col" class="text-center border-0">Egreso</th>
                    <th scope="col" class="text-center border-0">Tipo</th>
                    <th scope="col" class="text-center border-0">Concepto</th>
                    ...
                    @endif
                    <th scope="col" class="text-right border-0 pr-0">Stock</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
                ...
                @endif
                    <tr>
                        ...
                        <td class="text-right pl-0">Stock: </td>
                    ...
                    <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                        ...
                        <td class="text-right pl-0">Stock Actual: </td>
                        <td class="text-right pr-0 total-amount">
                            {{ $item->stockind }}
                        </td>
                    </tr>
