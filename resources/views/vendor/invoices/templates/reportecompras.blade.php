        ...
        <table class="table table-items">
            <thead>
                <tr style="background-color: #f3f4f6;">
                    <th scope="col" class="border-0 pl-0">Proveedor</th>
                    
                    <th scope="col" class="text-center border-0">Fecha</th>
                    <th scope="col" class="text-right border-0">No. Factura</th>
                    
                    <th scope="col" class="text-right border-0 pr-0">Total Factura</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
