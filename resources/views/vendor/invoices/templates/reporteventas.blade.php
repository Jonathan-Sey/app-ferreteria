...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        ...
                        @endif
                        <p>Fecha Imp.: <strong>{{ $invoice->getDate() }}</strong></p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0">ID Venta</th>
                    <th scope="col" class="border-0 pl-0">Doc</th>
                    @if($invoice->hasItemUnits)
                        <th scope="col" class="text-center border-0">Unidades</th>
                    @endif
                    <th scope="col" class="text-center border-0">Cliente</th>
                    <th scope="col" class="text-center border-0">Fecha</th>
                    <th scope="col" class="text-right border-0">Vendedor</th>
