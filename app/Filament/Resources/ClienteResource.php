...
class ClienteResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'custom-users';
        ...
        return $form
            ->schema([
                ...
                Select::make('pais_id')
                    ...
                    ->default(function (?Cliente $record) {
    ...
    {
        return parent::getEloquentQuery()->where('es_cliente', true);
    }
