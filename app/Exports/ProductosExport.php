...
class ProductosExport implements FromCollection, WithHeadings, WithStyles
{
    ...
    {
        //return Producto::select('codigo', 'nombre', 'descripcion', 'precio_compra','precio_venta', 'precio_mayoreo', 'id_marca', 'id_presentacion', 'id_categorias')->get();
        // Obtener los productos con las relaciones cargadas
